    ...
    return (
        <div className={styles.container}>
            <div className={styles.card}>
                ...
                <Link className={styles.link} href="/signup">Join</Link>
            </div>
            <div className={styles.card}>
...
const styles = {
  ...
  card: "space-x-4 bg-white shadow-md border border-gray-200 rounded-lg max-w-sm p-4 sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700",
