    ...
    <aside className={styles.sidebar}>
      <div className={styles.menu}>
        <ul className={styles.menulist}>
          <li>
            <Link className={styles.menulink} to="/app">
              <span className={styles.menuname}>Main</span>
            </Link>
          </li>
          <li>
            <Link className={styles.menulink} to="/app/tasks">
...
const styles = {
  ...
  menulink: "flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group",
